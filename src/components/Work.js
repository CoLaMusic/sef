...
const Work = () => {
  return <section className='section' id='munca'>
    ...
    <div className='flex flex-col lg:flex-row gap-x-10'>
      ...
      className='flex-1 flex flex-col gap-y-12 mb-10 lg:mb-0'>
        ...
        <div>
          ...
          <p className='max-w-sm mb-16'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Unde, numquam. Harum deleniti id sapiente velit inventore accusantium dicta magnam tempore?</p>
